...
export const DUMMY_SENTENCE_CARDS: SentenceCard[] = [
  {
    ...
    sentence: '보라. 기쁘며. 바이며. 품었기 모래뿐일 수 피다. 맺어. 거친 곳이 우리 공자는 무엇을 오직 끓는다, 그리하였는가? 원대하고, 피는 뛰노는 주며.',
    ideas: ['보이는 그와 생의 있으랴? 풀밭에 꽃 안고', '우리 설레는 석가는 그들은 하는 피에 밝은 생의 듣는다. 전인 꽃이 않는 것이다. 그들은 찬미를 위하여서. 실현에 황금시대를 할지니, 힘있다,'],
    bookmarked: false,
  },
  {
    id: 2,
